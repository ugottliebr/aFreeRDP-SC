...
public enum PcscReturnCode {
    ...
    public static PcscReturnCode fromValue(int value) throws InvalidParameterException {
        for (PcscReturnCode res : PcscReturnCode.values())
            if (value == res.getValue())
                return res;
        throw new InvalidParameterException(PcscReturnCode.class.getName() + " invalid value: " + String.format("0x%08X", value));
    }
